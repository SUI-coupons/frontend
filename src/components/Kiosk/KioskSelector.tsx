    ...
    return (
        <>
            <div className='flex items-center gap-2 relative z-50'>
                <label className='font-semibold'>Select a kiosk:</label>
                <Listbox value={selected} onChange={setSelected}>
                    <div className='relative mt-1'>
                        <Listbox.Button
                            className='relative w-full rounded-lg
           bg-[#191C1F] py-2 pl-3 pr-10 text-left focus:outline-none
           ...
           focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2
            ...
            '
              ...
              /> */}
                        ...
                        >
                            <Listbox.Options
                                className='absolute mt-1 z-50 max-h-60 w-full overflow-y-auto overflow-x-hidden rounded-md
            text-base shadow-lg ring-1
             border border-[#6B7280]
             ring-black ring-opacity-5 focus:outline-none sm:text-sm bg-[#191C1F]'
                            >
                                {caps.map(cap => (
                                    <Listbox.Option
                                        key={cap.objectId}
